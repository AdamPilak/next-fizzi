  ...
  return (
    ...
    >
      ...
      <div className="grid">
        ...
        <div className="text-side realtive z-[80] grid h-screen items-center gap-4 md:grid-cols-2">
          <PrismicNextImage
            className="w-full md:hidden"
            field={slice.primary.cans_image}
          />
          <div>
            <h2 className="text-side-heading text-5xl font-black text-balance text-sky-950 uppercase lg:text-7xl">
